...
public class SubroutineHierarchy extends JPanel {
	...
	private void drawWorld(Graphics2D g2) {
		rotatingThirteen(g2, 100, -1.02, -0.05);
		rotatingThirteen(g2, 100, 1.04, -0.9);
		rotatingThirteen(g2, 80, -1.3, 1.41);
		rotatingThirteen(g2, 80, -3.12, 2.22);
		rotatingThirteen(g2, 60, 0.85, 2.04);
		rotatingThirteen(g2, 60, 2.12, 1.44);
	...
	private void rotatingThirteen(Graphics2D g2, double r, double translate_x, double translate_y) {
